<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/hint.css/2.4.1/hint.min.css">/* 阅读进度 start */
...
function createtime1() {
  var grt = new Date("01/09/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("01/09/2024 00:00:00");
...
function setBg(s) {
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://vercel.gubaiovo.com/assets/pc_bg_light.jpg);
    --darkmode-bg: url(https://vercel.gubaiovo.com/assets/pc_bg_dark.jpg);
    --mobileday-bg: ${s};
    --mobilenight-bg: ${s};
  }`;
}
